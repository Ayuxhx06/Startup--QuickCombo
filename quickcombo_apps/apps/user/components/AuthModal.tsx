...
export default function AuthModal() {
  const { showAuthModal, setShowAuthModal, sendOtp, verifyOtp, googleLogin } = useAuth();
                ...
                {step === 'email' ? (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      disabled={loading}
                      className="w-full bg-white text-black py-3.5 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-gray-100 transition-all shadow-xl"
                    >
