...
export default function RiderLogin() {
  ...
  const loginWithGoogle = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      setLoading(true);
      try {
        const res = await axios.post(`${API}/api/rider/auth/google/`, {
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col items-center justify-center p-6 font-sans relative overflow-hidden">
      ...
      >
        ...
        <button 
          ...
          type="button"
          disabled={loading}
          className="w-full bg-white hover:bg-gray-100 text-black font-bold py-4 rounded-2xl flex items-center justify-center gap-3 transition-all mb-6 disabled:opacity-50"
        >
        ...
        <div className="relative flex items-center justify-center mb-6">
          ...
          <div className="relative bg-[#0a0a0a] px-4 text-xs font-bold text-gray-500 uppercase tracking-widest">
